<?php
 ...
 <div id="tabularpricepane" style="width:<?php echo $this->_config["tp_widget_width"]; ?>"  class="pane_style_4 <?php echo ( ( trim( $this->_config["display_title_price_over_image"] ) == "yes" ) ? "disp_title_over_img" : "" ); ?>">
